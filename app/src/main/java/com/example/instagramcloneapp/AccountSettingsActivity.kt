...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    private fun updateUserInfoOnly(){
        ...
        progressDialog.setMessage("Please wait, your profile is getting updated")
        progressDialog.show()
        ...
        when {
            ...
            bio_profile.text.toString() == "" -> {
                ...
                userMap["bio"] = bio_profile.text.toString()
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    Picasso.get().load(user!!.getImage()).placeholder(R.drawable.profile).into(
                        profile_image_view_profile_frag
                    )
                    ...
                    full_name_profile_frag.setText(str[0].capitalize() + " " + str[1].capitalize())
